...
# Usage: .\run.ps1 <script_name> [args...]
# Example: .\run.ps1 search_courses "keyword"
...
if (-not $SkillDir) { Write-Host "Cannot get script dir. Run run.ps1 from hd_skill folder." -ForegroundColor Red; exit 1 }
$scriptPath = Join-Path $SkillDir "scripts\$ScriptName.ps1"
$shPath = Join-Path $SkillDir "scripts\$ScriptName.sh"
